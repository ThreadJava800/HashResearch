...
Отсечь большое количество проверок можно зная длину строки (если длины двух строк не равны, то они заведомо не совпадают). Для этого, в списке, наряду с ключом и значением, хранится длина ключа. Таким образом, начнём с оптимизации поиска длины строки.\
