...
Также были рассмотрены ROL и ROR хеши, которые похожи по своему функционалу, который сдвигает влево (вправо) хеш и xor-ит его с очередным ASCII-кодом символа.
```C
